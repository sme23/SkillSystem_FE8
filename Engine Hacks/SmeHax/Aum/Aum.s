...
@make them be in the closest free tile to the active unit (for the time being this is just always the tile 1 above because figuring this out is hard)
ldr r0,=#0x03004E50 @active unit ptr
ldr r0,[r0] @active unit struct
ldrb r1,[r0,#0x11] @origin y coord
ldrb r0,[r0,#0x10] @origin x coord
sub r1,#1
...
@maybe do fancy visual stuff here
